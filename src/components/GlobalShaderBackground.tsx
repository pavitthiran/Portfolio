...
/*********
* Global Orbit Shader - Neon Green themed
* Logic migrated from Hero component
*/
precision highp float;
out vec4 O;
...
export const GlobalShaderBackground: React.FC = () => {
  const canvasRef = useShaderBackground();
  return (
    <canvas
      ref={canvasRef}
      className="fixed inset-0 w-full h-full object-cover touch-none -z-10 bg-black"
